...
{  
  ...
  public static void AddEntityNameApiClient(this IServiceCollection serviceCollection, string apiAddress)
    => AddClientsWithAddress(apiAddress, (apiUri) => AddEntityNameApiClient(serviceCollection, apiUri));
